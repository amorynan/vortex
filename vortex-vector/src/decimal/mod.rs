...
//!
//! The types that hold data are [`DVector`], which is generic over types `D` that
//! implement [`NativeDecimalType`].
//!
//! [`DecimalVector`] is an enums that wraps all the different possible [`DVector`]s. There are
//! several macros defined in this crate to make working with these
